...
export const CogIconSolid: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor">
...
export const BrainIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M4.871 14.746c1.088-.33 1.088-1.164 0-1.494-1.088-.33-1.088-1.164 0-1.494m13.17 3.013c1.088.33 1.088 1.164 0 1.494-1.088.33-1.088 1.164 0 1.494M9 10.5h6m-3-3v6m-3.129-6.354c-1.088.33-1.088 1.164 0 1.494l.001.001c1.088.33 1.088 1.164 0 1.494M12 21a9 9 0 110-18 9 9 0 010 18z" />
    </svg>
);
...
export const HandRaisedIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor">
        ...
        <path d="M11.55 5.538A10.51 10.51 0 002.25 12c0 2.23.704 4.312 1.914 6.045a.75.75 0 01-1.155.932A11.97 11.97 0 011.5 12c0-3.376 1.4-6.425 3.654-8.625a.75.75 0 011.144.975c-.21.246-.407.505-.59.774.24-.265.492-.516.756-.75.734-.65 1.55-1.218 2.42-1.68a.75.75 0 01.666 1.344zM16.104 2.822c.988.307 1.92.735 2.784 1.265a.75.75 0 01-.776 1.287A9.01 9.01 0 0015.86 4.25a.75.75 0 01.244-1.428z" />
         {/* Simplified Hand/Stop Shape */}
        <path fillRule="evenodd" d="M11.25 2a.75.75 0 01.75.75v3.19l.525-.262c.75-.375 1.637.15 1.637.994v5.394l.87-1.45a.75.75 0 011.286.77l-1.734 2.89a4.5 4.5 0 01-3.854 2.19h-1.46a4.5 4.5 0 01-3.854-2.19l-1.734-2.89a.75.75 0 011.286-.77l.87 1.45V6.672c0-.844.887-1.37 1.636-.995l.525.263V2.75a.75.75 0 01.75-.75z" clipRule="evenodd" />
    </svg>
);
